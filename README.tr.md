...
![Harita görünümü ve bilgi ipucu](assets/screenshots/map.png)

| Klasik yerleşim (SpaceMonger 1.4 tarzı) | Liste görünümü |
|---|---|
| ![Klasik yerleşim](assets/screenshots/classic.png) | ![Liste görünümü](assets/screenshots/list.png) |
...
- Ayarlar: yoğunluk, yatay/dikey eğilim, ipucu içeriği ve gecikmesi, Türkçe / English (sistem diline göre seçilir)
...
./install.sh      # ~/.local/bin + uygulama menüsü, sudo gerekmez
```
